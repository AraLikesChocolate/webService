...
<link href="${pageContext.request.contextPath}/asset/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/asset/css/creative.css" rel="stylesheet">

<!-- Plugin CSS -->
<link href="${pageContext.request.contextPath}/asset/vendor/magnific-popup/magnific-popup.css"
	rel="stylesheet">
</head>
<body id="page-top">
...
<!-- 						your template and start going, no strings attached!</p> -->
					<a class="btn btn-primary btn-xl js-scroll-trigger btn-loc" href="#about">서비스 소개</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 mx-auto text-center">
					...
					<a class="btn btn-light btn-xl js-scroll-trigger" href="#services">서비스로 이동</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container-fluid p-0">
			<div class="row no-gutters popup-gallery">
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="../asset/img/portfolio/fullsize/1.jpg"> <img
						class="img-fluid" src="../asset/img/portfolio/thumbnails/1.jpg" alt="">
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="../asset/img/portfolio/fullsize/2.jpg"> <img
						class="img-fluid" src="../asset/img/portfolio/thumbnails/2.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="../asset/img/portfolio/fullsize/3.jpg"> <img
						class="img-fluid" src="../asset/img/portfolio/thumbnails/3.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="../asset/img/portfolio/fullsize/4.jpg"> <img
						class="img-fluid" src="../asset/img/portfolio/thumbnails/4.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="../asset/img/portfolio/fullsize/5.jpg"> <img
						class="img-fluid" src="../asset/img/portfolio/thumbnails/5.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="../asset/img/portfolio/fullsize/6.jpg"> <img
						class="img-fluid" src="../asset/img/portfolio/thumbnails/6.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
...
<!-- 	</section> -->
	...
	<script src="${pageContext.request.contextPath}/asset/vendor/scrollreveal/scrollreveal.min.js"></script>
	<script src="${pageContext.request.contextPath}/asset/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>

	<!-- Custom scripts for this template -->
	<script src="${pageContext.request.contextPath}/asset/js/creative.min.js"></script>
