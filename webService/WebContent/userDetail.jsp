...
<body id="page-top">
	...
	<div id="my_container">
		<form method="post" action="userUpdate.go" name="userInfo" id="userInfo"
					...
					<div class="row username">
						<div class="large-9 columns large-centered">
							<label for="username"><i class="fa fa-user"></i></label> <input
								...
								value= "${user.name }" required autocomplete="off" readonly="readonly"/>
						</div>
					</div>
					<!-- 비밀번호 -->
					<div class="row password">
						<div class="large-9 columns large-centered">
							<label for="password"><i class="fa fa-lock"></i></label> <input
								...
								required autocomplete="off" placeholder="새로운 비밀번호를 입력하세요."/>
						</div>
					</div>
					<!-- 비밀번호 재입력 -->
					<div class="row password">
						<div class="large-9 columns large-centered">
							<label for="password_repeat"><i class="fa fa-lock"></i></label> <input
								id="password_repeat" type="password" name="password_repeat" placeholder="새로운 비밀번호를 다시 입력하세요."
